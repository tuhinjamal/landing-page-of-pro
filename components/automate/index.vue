<template>
  <div
    class="grid grid-cols-1 gap-[80px] lg:grid-cols-2 py-[60px] lg:py-[120px] justify-center items-center mx-[20px] md:mx-[32px] lg:mx-[120px] xl:mx-[120px] 2xl:mx-[240px]"
  >
