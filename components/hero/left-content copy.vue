  ...
  <div class="flex flex-col justify-center items-center md:items-start">
    ...
    <div class="mt-[24px] w-full space-y-4">
      ...
      >
        ...
        <p
          class="text-[#0D121D] text-[16px] lg:text-[17px] 2xl:text-[25px] leading-[160%] font-[600] 2xl:leading-[120%]"
        >
      ...
      <p
        :class="[
          'text-[#0D121D] text-[14px] lg:text-[14.5px] 2xl:text-[18px] font-bold mt-[16px] leading-[160%] transition-all duration-500 ease-out text-center md:text-start',
          show.paragraph
            ? 'opacity-100 translate-y-0 blur-0'
            : 'opacity-0 translate-y-10 blur-sm',
        ]"
